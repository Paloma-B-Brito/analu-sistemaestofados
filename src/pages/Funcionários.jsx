    ...
    <div className="bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden animate-fade-in">
      ...
      <div className="bg-[#064e3b] p-8 text-white flex justify-between items-center">
        <div>
          ...
          <h2 className="text-4xl font-black uppercase tracking-tighter">Quadro de Colaboradores</h2>
        </div>
        <button className="bg-[#b49157] text-white px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg">+ Adicionar Membro</button>
      </div>

      <div className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {colaboradores.map((colaborador) => (
            <div key={colaborador.id} className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm hover:border-[#b49157] transition-all relative overflow-hidden group">
                  ...
                  {editandoSenha === colaborador.id ? (
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="text-[10px] border-b-2 border-[#b49157] outline-none w-20 p-1"
              ...
              <div className="mt-6 flex justify-between gap-2">
                <button className="flex-1 py-2 bg-slate-50 text-[8px] font-black text-slate-500 uppercase rounded-lg hover:bg-slate-100 transition">Ver Ficha</button>
                <button className="flex-1 py-2 bg-slate-50 text-[8px] font-black text-slate-500 uppercase rounded-lg hover:bg-slate-100 transition">Ponto Eletrônico</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="bg-slate-50 px-8 py-4 border-t border-slate-100 flex gap-10">
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-amber-400"></div>
          <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Fábrica: 02 Operadores</p>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-emerald-400"></div>
          <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Loja: 02 Consultores</p>
        </div>
        <div className="flex items-center gap-2">
